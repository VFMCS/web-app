...
const getTransactionsByVendorID = "SELECT * FROM transactions WHERE vendor_id = $1 AND in_cart=false";
...
const completePastTransaction = "UPDATE past_transactions SET is_complete = TRUE";
